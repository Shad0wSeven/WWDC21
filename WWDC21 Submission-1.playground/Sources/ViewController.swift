...
// A Note, this file as well as almost all the other ones here were shared throughout the 4 View controllers which is why they are in "Shared Sources" While the rest of the files for VenusView and What Can We Do View are not.
...
//              ARSCNDebugOptions.showFeaturePoints
        ...
        self.earthNode.addChildNode(childNode2)
