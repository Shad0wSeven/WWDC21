...
// This file was created as sort of a last ditch effort which worked, to avoid a crash on iOS due to having too many objects
// While I realize JSON Would have been a better idea in this case, I was strapped for time and this was much faster for the 20 or so objects
// It is technically very rough but it gets the job done

// The point of it is to just store the location of the 5 points needed at each stage
